...
x = 0
#global = 1
"""global je jedno z klíčových slov jazyka python,
proto nemůže být použito jako název proměnné."""
Global = 1
PI = 3.14
city = "Opava"
#hilda@sspu-opava.cz = 'Hilda Dokonalá'
"""Součástí identifikátorů nemohou být symboly jako @."""
hildaZavinacSspuPomlckaOpavaTeckaCz = 'Hilda Dokonalá'
password2 = 'TajneHeslo'
#007agent = 'James Bond'
"""Identifikátory nesmí začínat číslicemi."""
agent007 = 'James Bond'
